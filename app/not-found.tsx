      ...
      <div className="h-screen flex flex-col items-center justify-center bg-neutral-100 dark:bg-gray-900 p-4">
        ...
        <div className="group relative flex flex-col items-center justify-center w-full max-w-lg h-[70%] md:max-w-3xl md:h-[480px] overflow-hidden rounded-xl bg-neutral-100 text-black dark:text-white cursor-pointer whitespace-normal dark:shadow-white border shadow-md z-20 hover:shadow-xl dark:bg-transparent">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <Link href="/">
              <button name='home' className="mt-6 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 w-full bg-slate-300 text-black dark:bg-slate-600 dark:text-white">
                Go Back Home
              </button>
            </Link>
          </div>
