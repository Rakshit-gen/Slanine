...
export function MarqueeDemo() {
    return (
        <div className="relative flex h-[600px] w-full flex-col items-center justify-center overflow-hidden md:rounded-[300px] bg-transparent">
            ...
            <Link
                href={"/dashboard"}
                className="z-30 inline-flex items-center justify-center px-7 py-2 transition ease-out mb-12 rounded-full cursor-pointer outline outline-2 outline-transparent outline-offset-4 border-2 border-blue-600 dark:text-white text-xl font-semibold bg-blue-600 text-white hover:bg-transparent hover:text-blue-600 hover:outline-blue-600 hover:dark:font-bold hover:duration-300"
            >
